...
export default function App() {
  ...
  useEffect(() => {
    fetch("/api/precios")
      .then((r) => r.json())
      .then((data) => { setPrecios(data); setLoadingPrecios(false); })
      .catch(() => { setErrorPrecios("No se pudieron cargar los precios. Recargá la página."); setLoadingPrecios(false); });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        {view === "informacion" && <Informacion onCotizar={() => setView("home")} />}
