...
// Botón que navega programáticamente al cotizador de Home
function CotizarBtn({ navigateToHomeSection }: { navigateToHomeSection: (sectionId: string) => void }) {
  return (
    <button
      type="button"
      onClick={() => navigateToHomeSection("cotizador-categorias")}
...
export default function Informacion({ navigateToHomeSection }: InformacionProps) {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-8">
        <CotizarBtn navigateToHomeSection={navigateToHomeSection} />
      </div>
